...
plt.scatter?
plt.scatter(y[:, 0], y[:, 1])    #scatter plot
...
ax.view_init(30, 60)  # changes the angle of view
...
plt.subplot(1, 3, 1) #nrows, ncols, index. Can be also written as 131
plt.bar(cat, val)
plt.subplot(1,3, 2)
plt.scatter(cat, val)
plt.subplot(1,3,3)
...
plt.plot(x, y, dashes = (5, 2, 1, 2), linestyle = 'dashed')  #  describes a sequence of 5 point and 1 point dashes separated by 2 point spaces.
